  ...
  return (
    <main className="min-h-screen bg-[#f8fafc] relative overflow-hidden">
      ...
      <motion.div 
        ...
        className="bg-gradient-to-br from-[#6b21a8] to-[#4338ca] pt-32 pb-24 px-6"
      >
      ...
      <motion.div 
        ...
        className="max-w-7xl mx-auto relative z-10 px-6 -mt-12"
      >
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          
          {/* Form Card */}
          <motion.div variants={itemVariants} className="lg:col-span-7 bg-white/70 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] border border-white shadow-[0_20px_50px_rgba(0,0,0,0.08)] flex flex-col justify-between">
        ...
        {/* Map Section */}
        <motion.div variants={itemVariants} className="mt-8 w-full h-[600px] rounded-[2.5rem] overflow-hidden border-4 border-white shadow-xl relative group mb-24">
          <iframe
