...
export default function CompanyOverview() {
  ...
  return (
    <section className="relative py-24 bg-[#F8F9FC] overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-purple-200/50 blur-[120px] rounded-full" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-cyan-200/50 blur-[100px] rounded-full" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex px-4 py-1.5 rounded-full border border-purple-200 bg-purple-50 text-purple-700 text-xs font-heading tracking-widest uppercase font-bold">
              Company Overview
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-24">
          {highlights.map((item, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-600 to-cyan-500 flex items-center justify-center mb-6">
