...

{
...

  {
    ...
    gallery: [
      ...
      "/images/sub-services/cnc-bending/cnc_3.png"
    ],
    ...
    features: [
      "Multi-Axis Precision Bending",
      "High-Tonnage Hydraulic Force",
      "Repeatable Complex Geometries",
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/sub-services/mig-welding/mig_3.png"
    ],
    ...
    features: [
      ...
      "Deep Penetration Integrity",
      "High-Deposition Efficiency",
      "Automated Shielding Precision"
    ],
  },
  {
    ...
    gallery: [
      ...
      "/images/sub-services/stamping-pressing/sp_3.png"
    ],
  ...
  },
{
    ...
    // Path updated to match the folder name: stainless-steel-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/stainless-steel-laser-cutting/ss_3.png"
    ],
    ...
    features: [
      "Nitrogen-Assisted Clean Cutting",
      "Oxide-Free Finish",
      "Minimal Heat-Affected Zone",
      "Food-Grade Precision"
    ],
  },
 {
    slug: "metal-sheet-laser-cutting",
    title: "Metal Sheet Laser Cutting",
    // Path updated to match the exact folder name: metal-sheet-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/metal-sheet-laser-cutting/ms_3.png"
    ],
  ...
  },
{
    ...
    // Path updated to match the folder name: cnc-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/cnc-laser-cutting/cl_3.png"
    ],
    ...
    features: [
      "CAD-to-Part Direct Integration",
      "Absolute Dimensional Consistency",
      "High-Speed Dynamic Processing",
      "Automated Toolpath Efficiency"
    ],
  },
 {
  slug: "brass-cutting",
...
},
 {
    ...
    // Path updated to match the folder name: pipe-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/pipe-laser-cutting/pl_3.png"
    ],
    ...
    features: [
      "Rotary Axis Tube Processing",
      "Complex Joint Notching",
      "Automated Profile Feeding",
      "Seamless Assembly Fit"
    ],
  },
  {
    slug: "ss-filter-plate-cuttings",
    title: "SS Filter Plate Cuttings",
    // Path updated to match the folder name: ss-filter-plate-cuttings
    ...
    gallery: [
      ...
      "/images/sub-services/ss-filter-plate-cuttings/ss_3.png"
    ],
    ...
    features: [
      "Precision Micro-Perforation",
      "Optimized Flow-Rate Control",
      "High-Rigidity Substrate",
      "Chemical-Resistant Processing"
    ],
  },
 {
...
},
{
    ...
    // Path updated to match the folder name: aluminum-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/aluminum-laser-cutting/al_3.png"
    ],
  ...
  },
  {
    ...
    gallery: [
      ...
      "/images/sub-jali-laser-cutting/mj_3.png"
    ],
    ...
    features: [
      "Complex Geometric Symmetry",
      "High-Detail Architectural Art",
      "Custom Pattern Capability",
      "Premium Interior/Exterior Grade"
    ],
  },
 {
    slug: "ss-jali-laser-cutting",
    title: "SS Jali Laser Cutting",
    // Path updated to match the folder name: ss-jali-laser-cutting
    ...
    gallery: [
      ...
      "/images/sub-services/ss-jali-laser-cutting/ss_3.png"
    ],
    ...
    features: [
      ...
      "Luxury Aesthetic Finish",
      "Architectural-Grade Precision",
      "Enduring Structural Quality"
    ],
  },
];
